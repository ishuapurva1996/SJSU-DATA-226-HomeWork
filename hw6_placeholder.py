...
def extract(city, longitude, latitude):
    ...
    safe_city = city.replace(" ", "_")  # Replace spaces with underscores for the file name
...
with DAG(
    ...
    database = "USER_DB_BADGER"           # TO DO: Set the database name  
    schema = "raw"
    target_table = "weather_data_HW6_inc"       # TO DO: Set the target table name
